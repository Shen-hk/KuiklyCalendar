...
val businessPathName = "KuiklyCalendar"
...
fun copyLocalJSBundle() {
    ...
    // Input target path, in KuiklyCalendar/outputs/kuikly/js/release/local/nativevue2.zip
...
fun copySplitJSBundle() {
    ...
    // Input target path, in KuiklyCalendar/outputs/kuikly/js/release/split/page
